 ...
 */
public class ResourceUnobfuscatorTest {
    ...
    /**
     * Test for {@link ResourceObfuscator#unobfuscate(String, String[], String[])}.
     */
    @Test
    public void testUnobfuscate() {

        String actualPlainString = null;

        try {
            actualPlainString = ResourceObfuscator.unobfuscate(expectedObfuscatedString,
        ...
        assertEquals(actualPlainString, expectedPlainString);
    }
