 ...
 */
package com.amazon.android.uamp.constants;
...
/**
 * A compatibility wrapper for {@link CaptioningManager.CaptionStyle}.
 */
public final class CaptionStyleCompat {
    ...
    /**
     * Creates a {@link CaptionStyleCompat} equivalent to a provided {@link
     * CaptioningManager.CaptionStyle}.
     *
     * @param captionStyle A {@link CaptioningManager.CaptionStyle}.
    ...
    public static CaptionStyleCompat createFromCaptionStyle(
        ...
        if (SDK_INT >= 21) {
            ...
            // Note - Any caller must be on at least API level 19 or greater (because
            // CaptionStyle did
    ...
    private static CaptionStyleCompat createFromCaptionStyleV21(
        ...
        return new CaptionStyleCompat(
                captionStyle.hasForegroundColor() ?
                        captionStyle.foregroundColor : DEFAULT.foregroundColor,
                captionStyle.hasBackgroundColor() ?
                        captionStyle.backgroundColor : DEFAULT.backgroundColor,
